...
class BiGRUAttention:
    def __init__(self, loss_number, num_count, num_classes, learning_rate, batch_size, decay_steps, decay_rate, sequence_length, char_length, num_sentences,
                 vocab_size, char_size, embed_size,hidden_size, is_training, multi_label_flag=True,char_attention_flag=False, count_flag=False,initializer=initializers.xavier_initializer(),clip_gradients=5.0):
