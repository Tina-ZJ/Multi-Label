...
def sample_to_tfrecord(sample_file, tfrecord_file, term_index, char_index, cid_name_file):
...
if __name__ == '__main__':
    ...
    train_sample_size = sample_to_tfrecord(args.train_sample_file, train_tfrecord_file, term_index, char_index,args.cid_name_file)
    print('train sample transfer to tfrecord succeed....')
    dev_sample_size = sample_to_tfrecord(args.dev_sample_file, dev_tfrecord_file, term_index, char_index, args.cid_name_file)
