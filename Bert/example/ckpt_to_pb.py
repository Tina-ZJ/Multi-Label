...
sys.path.append('../')
MODEL_DIR= '/home/zhangjun386/bert/bert_multi_class/example/bert_checkpoint'
...
def freeze_graph(input_checkpoint_dir, output_graph):
    ...
    output_node_names = ['input_ids', 'input_mask', 'segment_ids', 'is_training', 'accuracy/precision', 'accuracy/recall','accuracy/f1', 'loss/logits']
...
if __name__ == '__main__':
  ...
  #test = get_graph_def_from_saved_model('../example/bert_checkpoints/checkpoints')
  test = get_size(input_checkpoint, 'frozen_model.pb')
